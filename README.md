...
| --- | --- | --- | --- |
| [Special Everyone](./special-everyone-portfolio) | UX Research / Service Planning | 제4회 CUK혁신 아이디어 경진대회 장려상 | 발표 담당, HTML 프로토타입 제작, 접근성 개선안 정리 |
...
[Special Everyone Portfolio](./special-everyone-portfolio)

공유대학(CU12) 환경에서 장애학생과 다양한 학습자가 강의 수강, 자료 접근, 팀 협업 과정에서 겪을 수 있는 접근성 문제를 분석하고 서비스 개선안을 제안한 프로젝트입니다.

![Special Everyone cover](./special-everyone-portfolio/docs/images/slide-cover-01.png)
...
- [README](./special-everyone-portfolio)
- [Web Prototype](./special-everyone-portfolio/index.html)
...
![Debate award](./debate-award-portfolio/docs/images/award-photo.png)
